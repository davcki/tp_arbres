...
Affichons-le:
![Arbre de décision au critère d'Entropie calculé avec data4](representation_arbres_pdf/checkers_tree.pdf){width=100%}
...
Affichons-le:
![Arbre de décision au critère d'Entropie calculé avec digits](representation_arbres_pdf/digits_tree.pdf){width=100%}
